#!/usr/bin/env python3
"""
Generate House Scene - Automatic Blender File Creation
This script creates a complete 3D house scene and automatically opens it in Blender.
"""
...
def create_house_scene():
    """Create a complete 3D house scene."""
...
def open_in_blender(file_path):
    """Open the Blender file in Blender."""
    try:
        # Try to open with Blender
        subprocess.run(["blender", file_path], check=True)
        print("🎉 Blender file opened successfully!")
    except subprocess.CalledProcessError:
        print("❌ Could not open Blender automatically.")
        ...
        print(f"📁 Then open this file: {file_path}")

if __name__ == "__main__":
    # Create the scene
    blend_file = create_house_scene()
    
    # Open in Blender
    open_in_blender(blend_file)
