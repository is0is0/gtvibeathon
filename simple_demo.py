#!/usr/bin/env python3
"""
Simple Demo - Shows Voxel system capabilities without API calls
"""
...
def main():
    """Run a simple demo showing the Voxel system."""
    print("🎨 Voxel Simple Demo - AI-Powered 3D Scene Generation")
    print("=" * 60)
    print()
