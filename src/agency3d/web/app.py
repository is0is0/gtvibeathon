...
from agency3d.web.context_handler import ContextHandler
from agency3d.web.session_manager import SessionManager
...
def run_generation(app, session_id: str, prompt: str, selected_agents: List[str], context_files: List[str]):
    ...
    with app.app_context():
        try:
            ...
            agency.set_progress_callback(on_progress)
